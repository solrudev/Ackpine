 ...
 * under the License.
 */
package ru.solrudev.ackpine.compress.compressors.xz;
...
public class XZCompressorInputStream extends CompressorInputStream implements InputStreamStatistics {
	...
	// @formatter:off
	/**
	 * Builds a new {@link XZCompressorInputStream}.
	 *
	 * <p>
	 * For example:
	 * </p>
	...
	/**
	 * Constructs a new builder of {@link XZCompressorInputStream}.
	 *
	 * @return a new builder of {@link XZCompressorInputStream}.
	 * @since 1.28.0
	 */
	...
	public long skip(final long n) throws IOException {
		try {
			return ru.solrudev.ackpine.compress.utils.IOUtils.skip(in, n);
		} catch (final org.tukaani.xz.MemoryLimitException e) {
			// convert to commons-compress MemoryLimtException
			throw new MemoryLimitException(e.getMemoryNeeded(), e.getMemoryLimit(), (Throwable) e);
		}
