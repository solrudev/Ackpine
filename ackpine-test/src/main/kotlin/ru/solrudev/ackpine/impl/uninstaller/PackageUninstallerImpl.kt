...
internal interface PackageUninstallerImpl : PackageUninstaller {
	...
	companion object {
		...
		internal fun getInstance(context: Context): PackageUninstallerImpl {
			...
			synchronized(lock) {
				...
				if (instance == null) {
					instance = TestPackageUninstallerBridge()
	...
	private class TestPackageUninstallerBridge : TestPackageUninstaller(), PackageUninstallerImpl
}