...
internal interface PackageInstallerImpl : PackageInstaller {
	...
	companion object {
		...
		internal fun getInstance(context: Context): PackageInstallerImpl {
			...
			synchronized(lock) {
				...
				if (instance == null) {
					instance = TestPackageInstallerBridge()
	...
	private class TestPackageInstallerBridge : TestPackageInstaller(), PackageInstallerImpl
}