...
public class AckpineLibraryBasePlugin : Plugin<Project> {
	...
	override fun apply(target: Project): Unit = target.run {
		...
		val apiValidationExtensionProvider = { extensions.findByType<ApiValidationExtension>() }
		extensions.create<AckpineLibraryExtension>("ackpine", libraryExtension, apiValidationExtensionProvider)
		configureAndroid()
