...
/**
 * DSL allowing to configure [install parameters for ShizukuPlugin][ShizukuPlugin.InstallParameters].
 */
@SessionParametersDsl
public interface ShizukuInstallParametersDsl {
...
@PublishedApi
internal open class ShizukuInstallParametersDslBuilder : ShizukuInstallParametersDsl {

	private val builder = ShizukuPlugin.InstallParameters.Builder()
