...
The `ackpine-test` artifact provides test doubles and utilities to drive [session](../architecture.md#session-state-machine) state and progress deterministically.
